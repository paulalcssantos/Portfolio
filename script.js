    ...
    experienceSection: {
        ...
        voluntary: [
            { role: 'Diretora', 
                ...
                period: 'Desde 2022', 
                description: ['Iniciei na organização sem fins lucrativos WorldWide Women in Tech como embaixadora em 2022 e, desde 2024, atuo como diretora, liderando iniciativas voltadas ao fortalecimento da participação de mulheres em STEM (Ciência, Tecnologia, Engenharia e Matemática). Sou responsável pela coordenação de programas de mentoria, organização de eventos e desenvolvimento de parcerias com organizações e instituições de ensino. Atuo também na gestão da comunidade e na criação de oportunidades de desenvolvimento profissional para mulheres na tecnologia e áreas relacionadas.'] },
            { role: 'Instrutora', 
    ...
    experienceSection: {
        ...
        voluntary: [
            { role: 'Director', 
                company: 'WorldWide Women in Tech', 
                period: 'Since 2022', 
                description: ['I joined the non-profit organization WorldWide Women in Tech as an ambassador in 2022 and, since 2024, I have been serving as a director, leading initiatives aimed at strengthening women’s participation in STEM (Science, Technology, Engineering, and Mathematics). I am responsible for coordinating mentorship programs, organizing events, and developing partnerships with organizations and educational institutions. I also work on community management and on creating professional development opportunities for women in technology and related fields.'] },
            { role: 'Instructor', 
                company: 'WoMakersCode',
                period: 'Since 2025', 
